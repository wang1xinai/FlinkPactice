...
*          ~ ProcessFunction
*          ~ KeyedProcessFunction<K, I, O>                     **** KeyedStream，来一条数据处理一次, def processElement(value)
*          ~ CoProcessFunction<IN1, IN2, OUT>
*          ~ ProcessJoinFunction<IN1, IN2, OUT>
*          ~ BroadcastProcessFunction<IN1, IN2, OUT>
*          ~ KeyedBroadcastProcessFunction<KS, IN1, IN2, OUT>
*          ~ ProcessWindowFunction<IN, OUT, KEY, W extends Window>  在KeyedStream上计算， def process(elements)
*          ~ ProcessAllWindowFunction<IN, OUT, W extends Window>    不需要分流KeyBy，直接在DataStream上计算
 *
 ...
 */
public class ManipulationFunctionEachElement {
